...
if __name__ == '__main__':
    ...
    if not args.list_all and not args.all and not args.lang and not args.dataset and not args.model and not args.name and not args.re:
...
def download_selected_models(languages=[], datasets=[], models=[], patterns=[], regexps=[], dryrun=False):
...
if __name__ == '__main__':
    ...
    download_selected_models(args.lang, args.dataset, args.model, args.name, args.re, dryrun=args.dry_run)
